...
const KurumKayitOl = () => {
    ...
    const onFormSubmit = (event) => {
        ...
        setHata("");
        const objj = {
            kurumAd: gonderilecek.kurumAd, kurumAciklama: gonderilecek.kurumAciklama, adres: gonderilecek.adres,
    ...
    return (
        <React.Fragment>
            <h3>Kurum Kayıt Formu</h3>

            <form>
                <label>Kurum adı</label>
                <input type="text" required name="kurumAd" placeholder="Kurumun adını giriniz..." onChange={onInputChange} />
                ...
                <button id="buton" type="submit" onClick={onFormSubmit}>Gönder</button>
